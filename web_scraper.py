...
def figure_out_development(age, rating, player_pot, date_of_birth, next_to_one, player_stats, position) :
    ...
    return final_development_plan, counting_days_array, final_development_plan2, counting_days_array2
...
for operation_index in range(2) :
    ...
    for team_in_league in teams_in_league :
        ...
        for player_link in player_links :
            ...
            final_development_plan, counting_days_array, final_development_plan2, counting_days_array2 = figure_out_development(age, rating, player_pot, player_data['Date of Birth'], player_data['NextToOne'], player_data['Player Stats'], player_data['Position'])
